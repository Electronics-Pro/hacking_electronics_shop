...
def header(header,pdf):
  ...
  pdf.drawString(30,800,"Hacking Electronics Shop")
  pdf.setFont("Courier-Bold",11)
  pdf.drawString(30,785,"A-10 Rama Crest,")
  pdf.drawString(30,770,"Sunpharma Road,")
  pdf.drawString(30,755,"390012. Phone: +91 9874950391")
  ...
  data = 'InvoiceNumber:' + str(int(header.InvoiceNumber))+'\nTime:'+(header.date+"--"+header.time)+"\nGoogle Map: https://goo.gl/maps/DV59uHs2eoYpuvsC9\nTerms & Conditions:\n1:Sold items can be returned or changed only if are in saleable condition.\n2:Every dispute will settled in High Court.\n3:All parts come with 15 day warranty against manufacturing defects.\n4:Warranty is not applicable on any form of damage caused by mishandling.\nTHANK YOU"
  qr.add_data(data)
  qr.make(fit = True)

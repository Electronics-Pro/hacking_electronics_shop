...
def onExit():
    he_db.close()
    messagebox.showinfo("Thank you!","Thank you for shopping with us. Come back soon!")
...
def user_wl(username):
	...
	sh_ddon["menu"].config(bg="#202020")
	sh_ddon["menu"].config(fg="white")
	sh_ser = Button(mainscrn,text="Search My Wishlist",bg="#202020",fg="white")

	ad_crt = LabelFrame(mainscrn,background="#202020")
	ad_lb1 = Label(ad_crt,text="Select item, ",background="#202020",foreground="white").grid(row=0,column=0,padx=60)
	ad_wli = Button(ad_crt,text="Delete",bg="#202020",fg="white").grid(row=0,column=1,padx=70)
	ad_lb2 = Label(ad_crt,text="                  --OR--                                          Specify Quantity:  ",bg="#202020",fg="white").grid(row=0,column=2)
	ad_spn = Spinbox(ad_crt,from_=1,to=999,width=3,bg="#202020",fg="white").grid(row=0,column=3)
	ad_crb = Button(ad_crt,text="Add to Cart",bg="#202020",fg="white").grid(row=0,column=4,padx=100)
...
def user_cart(username):
	...
	sh_ddon["menu"].config(bg="#202020")
	sh_ddon["menu"].config(fg="white")
	sh_ser = Button(mainscrn,text="Search My Cart",bg="#202020",fg="white")
